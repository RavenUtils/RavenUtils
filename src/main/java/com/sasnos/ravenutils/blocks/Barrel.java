    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!worldIn.isRemote) {
            ...
            if (playerItem.getItem() == ModItems.BARREL_LIT.get() && !state.get(Barrel.HAS_LID)) {
                ...
                player.addItemStackToInventory(new ItemStack(ModItems.BARREL_LIT.get()));
                return ActionResultType.SUCCESS;
            }
            ...
            if (playerItem.getCapability(CapabilityFluidHandler.FLUID_HANDLER_ITEM_CAPABILITY).isPresent() ||
                    playerItem.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY).isPresent()) {
