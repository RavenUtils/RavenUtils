...
public class HandMillInit {
  ...
  public static final RegistryObject<ContainerType<HandMillContainer>> HAND_MILL_CONTAINER = ModContainer.CONTAINERTYPES.register("hand_mill",
      () -> IForgeContainerType.create(HandMillContainer::new));
}
