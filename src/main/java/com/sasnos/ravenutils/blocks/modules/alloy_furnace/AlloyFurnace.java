...
public class AlloyFurnace extends EssentialsMachineBlock {
  ...
  protected static final VoxelShape SHAPE_E = Stream.of(
      Block.makeCuboidShape(0, 0, 0, 15, 3, 16),
      Block.makeCuboidShape(2, 13, 2, 14, 16, 14),
      Block.makeCuboidShape(15, 0, 1, 16, 15, 15),
      Block.makeCuboidShape(0, 3, 15, 1, 16, 16),
      Block.makeCuboidShape(1, 15, 15, 15, 16, 16),
      Block.makeCuboidShape(0, 3, 0, 1, 16, 1),
      Block.makeCuboidShape(15, 0, 0, 16, 16, 1),
  ...
  protected static final VoxelShape SHAPE_S = Stream.of(
      ...
      Block.makeCuboidShape(2, 13, -1, 14, 16, 13),
      Block.makeCuboidShape(1, 0, 14, 15, 15, 15),
      Block.makeCuboidShape(0, 3, -1, 1, 16, 0),
      Block.makeCuboidShape(0, 15, 0, 1, 16, 14),
      Block.makeCuboidShape(15, 3, -1, 16, 16, 0),
      Block.makeCuboidShape(15, 0, 14, 16, 16, 15),
      Block.makeCuboidShape(0, 0, 14, 1, 16, 15),
      Block.makeCuboidShape(2, 3, 0, 14, 16, -1),
      Block.makeCuboidShape(2, 8, 13, 14, 16, 14),
      Block.makeCuboidShape(14, 3, 0, 15, 16, 14),
      Block.makeCuboidShape(1, 3, 0, 2, 16, 14),
      Block.makeCuboidShape(15, 15, 0, 16, 16, 14),
      Block.makeCuboidShape(1, 15, -1, 15, 16, 0),
