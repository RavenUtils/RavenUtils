...
public class ModBlocks {
  ...
  // ores
  public static final RegistryObject<Block> RAVENINE_ORE = BLOCKS.register("ravenine_ore", MytherineOre::new);
  ...
  // blocks
  public static final RegistryObject<Block> RAVENINE_BLOCK = BLOCKS.register("ravenine_block", MytherineBlock::new);
