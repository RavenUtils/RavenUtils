...
public class EssentialBlockTags extends BlockTagsProvider {
  ...
  public EssentialBlockTags(DataGenerator dataGenerator, String modId, @Nullable ExistingFileHelper existingFileHelper) {
